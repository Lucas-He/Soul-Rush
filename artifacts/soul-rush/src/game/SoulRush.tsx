...
const BOSSES: BossConf[] = [
  ...
  },
  {
    ...
    waves: [
      ...
      { id: 's6', name: 'Soul Duel V', description: 'Mirror soul fires precision aimed volleys.', duration: 6, attackType: 'mirror', warningType: 'mirror', bulletSpeed: 165, spawnRate: 5, damage: 15, arenaEffect: 'mirror', patternTags: ['mirror', 'aimed'], execute: 'soulDuel' },
      ...
      { id: 's10', name: 'Broken Controls V', description: 'Controls flip while bullet rain intensifies.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 207, spawnRate: 10, damage: 15, arenaEffect: 'flip', patternTags: ['rain', 'flip'], execute: 'brokenControls' },
      ...
      { id: 's14', name: 'Regret Spiral VII', description: 'Spiraling regret at maximum arm count.', duration: 5, attackType: 'spiral', warningType: 'ring', bulletSpeed: 188, spawnRate: 8, damage: 15, arenaEffect: 'none', patternTags: ['spiral', 'dense'], execute: 'regretSpiral' },
      ...
      { id: 's19', name: 'Soul Duel VI', description: 'The mirror soul reflects your every move.', duration: 6, attackType: 'mirror', warningType: 'mirror', bulletSpeed: 172, spawnRate: 5, damage: 15, arenaEffect: 'mirror', patternTags: ['mirror', 'aimed'], execute: 'soulDuel' },
