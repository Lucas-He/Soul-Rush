...
const BOSSES: BossConf[] = [
  ...
  },
  {
    ...
    rewardItemPool: ['wax_seal', 'candle_ash'],
    waves: [
      { id: 'c1', name: 'Wax Drip', description: 'Sinusoidal dripping bullets.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 160, spawnRate: 8, damage: 20, arenaEffect: 'wax', patternTags: ['rain', 'arc'], execute: 'waxDrip' },
      { id: 'c2', name: 'Funeral March', description: 'Slow dense rows of bullets.', duration: 5, attackType: 'wall', warningType: 'top', bulletSpeed: 80, spawnRate: 8, damage: 20, arenaEffect: 'none', patternTags: ['wall', 'dense'], execute: 'funeralMarch' },
      { id: 'c3', name: 'Last Ember', description: 'Long warning then total burst.', duration: 5, attackType: 'radial', warningType: 'pulse', bulletSpeed: 175, spawnRate: 40, damage: 20, arenaEffect: 'none', patternTags: ['radial', 'burst'], execute: 'lastEmber' },
      { id: 'c4', name: 'Wax Flood', description: 'Danger zones flood from top.', duration: 5, attackType: 'zone', warningType: 'area', bulletSpeed: 0, spawnRate: 3, damage: 20, arenaEffect: 'wax', patternTags: ['zone'], execute: 'waxFlood' },
      { id: 'c5', name: 'Candle Tears', description: 'Arcing streams from above.', duration: 5, attackType: 'arc', warningType: 'top', bulletSpeed: 140, spawnRate: 5, damage: 20, arenaEffect: 'none', patternTags: ['arc', 'spread'], execute: 'candleTears' },
      { id: 'c6', name: 'Wax Drip II', description: 'Heavier wax drip.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 162, spawnRate: 8, damage: 20, arenaEffect: 'wax', patternTags: ['rain'], execute: 'waxDrip' },
      { id: 'c7', name: 'Funeral March II', description: 'Faster dense rows.', duration: 5, attackType: 'wall', warningType: 'top', bulletSpeed: 85, spawnRate: 8, damage: 20, arenaEffect: 'none', patternTags: ['wall'], execute: 'funeralMarch' },
      { id: 'c8', name: 'Wax Flood II', description: 'Denser zone flood.', duration: 5, attackType: 'zone', warningType: 'area', bulletSpeed: 0, spawnRate: 3, damage: 20, arenaEffect: 'wax', patternTags: ['zone'], execute: 'waxFlood' },
      { id: 'c9', name: 'Candle Tears II', description: 'Heavier arc streams.', duration: 5, attackType: 'arc', warningType: 'top', bulletSpeed: 145, spawnRate: 5, damage: 20, arenaEffect: 'none', patternTags: ['arc'], execute: 'candleTears' },
      { id: 'c10', name: 'Last Ember II', description: 'Brighter ember burst.', duration: 5, attackType: 'radial', warningType: 'pulse', bulletSpeed: 178, spawnRate: 40, damage: 20, arenaEffect: 'none', patternTags: ['radial'], execute: 'lastEmber' },
      { id: 'c11', name: 'Wax Drip III', description: 'Dense wax drip.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 164, spawnRate: 9, damage: 20, arenaEffect: 'wax', patternTags: ['rain'], execute: 'waxDrip' },
      { id: 'c12', name: 'Wax Flood III', description: 'Max zone flood.', duration: 5, attackType: 'zone', warningType: 'area', bulletSpeed: 0, spawnRate: 4, damage: 20, arenaEffect: 'wax', patternTags: ['zone'], execute: 'waxFlood' },
      { id: 'c13', name: 'Candle Tears III', description: 'Widest arc spread.', duration: 5, attackType: 'arc', warningType: 'top', bulletSpeed: 148, spawnRate: 5, damage: 20, arenaEffect: 'none', patternTags: ['arc'], execute: 'candleTears' },
      { id: 'c14', name: 'Wax Flood IV', description: 'Final zone flood.', duration: 5, attackType: 'zone', warningType: 'area', bulletSpeed: 0, spawnRate: 4, damage: 20, arenaEffect: 'wax', patternTags: ['zone'], execute: 'waxFlood' },
      { id: 'c15', name: 'Last Ember III', description: 'Maximum ember burst.', duration: 5, attackType: 'radial', warningType: 'pulse', bulletSpeed: 180, spawnRate: 44, damage: 20, arenaEffect: 'none', patternTags: ['radial'], execute: 'lastEmber' },
      { id: 'c16', name: 'Wax Drip IV', description: 'Final wax drip wave.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 166, spawnRate: 9, damage: 20, arenaEffect: 'wax', patternTags: ['rain'], execute: 'waxDrip' },
      { id: 'c17', name: 'Funeral March III', description: 'Final dense procession.', duration: 5, attackType: 'wall', warningType: 'top', bulletSpeed: 88, spawnRate: 8, damage: 20, arenaEffect: 'none', patternTags: ['wall'], execute: 'funeralMarch' },
      { id: 'c18', name: 'Final Ember', description: 'The last ember — max burst.', duration: 5, attackType: 'radial', warningType: 'pulse', bulletSpeed: 182, spawnRate: 48, damage: 20, arenaEffect: 'none', patternTags: ['radial'], execute: 'lastEmber' },
    ],
  },
  {
    name: 'Zylvira',
  ...
  },
  {
    ...
    waves: [
      { id: 'm1', name: 'Echo Trail', description: 'Bullets from past player positions.', duration: 5, attackType: 'echo', warningType: 'trail', bulletSpeed: 130, spawnRate: 5, damage: 18, arenaEffect: 'echo', patternTags: ['echo', 'memory'], execute: 'echoTrail' },
      { id: 'm2', name: 'Memory Replay', description: 'Replays a boss 1–5 attack.', duration: 5, attackType: 'replay', warningType: 'random', bulletSpeed: 0, spawnRate: 0, damage: 18, arenaEffect: 'none', patternTags: ['replay'], execute: 'memoryReplay' },
      { id: 'm3', name: 'Vault Lock', description: 'Grid laser with blinking pattern.', duration: 5, attackType: 'grid', warningType: 'grid', bulletSpeed: 0, spawnRate: 4, damage: 18, arenaEffect: 'none', patternTags: ['laser', 'grid'], execute: 'vaultLock' },
      { id: 'm4', name: 'Crystal Repeat', description: 'Rain pattern played twice.', duration: 6, attackType: 'rain', warningType: 'top', bulletSpeed: 190, spawnRate: 10, damage: 18, arenaEffect: 'none', patternTags: ['rain', 'repeat'], execute: 'crystalRepeat' },
      { id: 'm5', name: 'Echo Trail II', description: 'Heavier echo burst.', duration: 5, attackType: 'echo', warningType: 'trail', bulletSpeed: 135, spawnRate: 5, damage: 18, arenaEffect: 'echo', patternTags: ['echo'], execute: 'echoTrail' },
      { id: 'm6', name: 'Vault Lock II', description: 'Alternate lock pattern.', duration: 5, attackType: 'grid', warningType: 'grid', bulletSpeed: 0, spawnRate: 4, damage: 18, arenaEffect: 'none', patternTags: ['laser'], execute: 'vaultLock' },
      { id: 'm7', name: 'Crystal Repeat II', description: 'Offset repeat rain.', duration: 6, attackType: 'rain', warningType: 'top', bulletSpeed: 195, spawnRate: 10, damage: 18, arenaEffect: 'none', patternTags: ['rain'], execute: 'crystalRepeat' },
      { id: 'm8', name: 'Echo Trail III', description: 'Dense echo volleys.', duration: 5, attackType: 'echo', warningType: 'trail', bulletSpeed: 140, spawnRate: 5, damage: 18, arenaEffect: 'echo', patternTags: ['echo'], execute: 'echoTrail' },
      { id: 'm9', name: 'Vault Lock III', description: 'Double blink lock.', duration: 5, attackType: 'grid', warningType: 'grid', bulletSpeed: 0, spawnRate: 4, damage: 18, arenaEffect: 'none', patternTags: ['laser'], execute: 'vaultLock' },
      { id: 'm10', name: 'Crystal Repeat III', description: 'Max offset repeat.', duration: 6, attackType: 'rain', warningType: 'top', bulletSpeed: 200, spawnRate: 10, damage: 18, arenaEffect: 'none', patternTags: ['rain'], execute: 'crystalRepeat' },
      { id: 'm11', name: 'Echo Trail IV', description: 'Max trail burst.', duration: 5, attackType: 'echo', warningType: 'trail', bulletSpeed: 145, spawnRate: 5, damage: 18, arenaEffect: 'echo', patternTags: ['echo'], execute: 'echoTrail' },
      { id: 'm12', name: 'Memory Replay II', description: 'Different boss replay.', duration: 5, attackType: 'replay', warningType: 'random', bulletSpeed: 0, spawnRate: 0, damage: 18, arenaEffect: 'none', patternTags: ['replay'], execute: 'memoryReplay' },
      { id: 'm13', name: 'Vault Lock IV', description: 'Final dual lock.', duration: 5, attackType: 'grid', warningType: 'grid', bulletSpeed: 0, spawnRate: 4, damage: 18, arenaEffect: 'none', patternTags: ['laser'], execute: 'vaultLock' },
      { id: 'm14', name: 'Crystal Repeat IV', description: 'Max crystal repeat.', duration: 6, attackType: 'rain', warningType: 'top', bulletSpeed: 205, spawnRate: 10, damage: 18, arenaEffect: 'none', patternTags: ['rain'], execute: 'crystalRepeat' },
      { id: 'm15', name: 'Echo Trail V', description: 'Final echo trail.', duration: 5, attackType: 'echo', warningType: 'trail', bulletSpeed: 150, spawnRate: 5, damage: 18, arenaEffect: 'echo', patternTags: ['echo'], execute: 'echoTrail' },
      { id: 'm16', name: 'Memory Replay III', description: 'Third unique replay.', duration: 5, attackType: 'replay', warningType: 'random', bulletSpeed: 0, spawnRate: 0, damage: 18, arenaEffect: 'none', patternTags: ['replay'], execute: 'memoryReplay' },
      { id: 'm17', name: 'Vault Lock V', description: 'Max vault grid.', duration: 5, attackType: 'grid', warningType: 'grid', bulletSpeed: 0, spawnRate: 4, damage: 18, arenaEffect: 'none', patternTags: ['laser'], execute: 'vaultLock' },
      { id: 'm18', name: 'Crystal Repeat V', description: 'Dense repeated rain.', duration: 6, attackType: 'rain', warningType: 'top', bulletSpeed: 208, spawnRate: 10, damage: 18, arenaEffect: 'none', patternTags: ['rain'], execute: 'crystalRepeat' },
      { id: 'm19', name: 'Echo Trail VI', description: 'Heavy final echo.', duration: 5, attackType: 'echo', warningType: 'trail', bulletSpeed: 155, spawnRate: 5, damage: 18, arenaEffect: 'echo', patternTags: ['echo'], execute: 'echoTrail' },
      { id: 'm20', name: 'Vault Lock VI', description: 'Final lock pattern.', duration: 5, attackType: 'grid', warningType: 'grid', bulletSpeed: 0, spawnRate: 4, damage: 18, arenaEffect: 'none', patternTags: ['laser'], execute: 'vaultLock' },
      { id: 'm21', name: 'Echo Trail VII', description: 'Maximum echo volleys.', duration: 5, attackType: 'echo', warningType: 'trail', bulletSpeed: 160, spawnRate: 5, damage: 18, arenaEffect: 'echo', patternTags: ['echo'], execute: 'echoTrail' },
      { id: 'm22', name: 'Final Repeat', description: 'Final repeated crystal.', duration: 6, attackType: 'rain', warningType: 'top', bulletSpeed: 215, spawnRate: 10, damage: 18, arenaEffect: 'none', patternTags: ['rain'], execute: 'crystalRepeat' },
    ],
  },
  {
    name: 'Lunara',
    ...
    waves: [
      { id: 'lu1', name: 'String Pull', description: 'Diagonal forced movement + bullets.', duration: 5, attackType: 'pull', warningType: 'arrow', bulletSpeed: 160, spawnRate: 6, damage: 17, arenaEffect: 'pull', patternTags: ['pull', 'homing'], execute: 'stringPull' },
      { id: 'lu2', name: 'Puppet Dance', description: 'Laser walls with narrow safe path.', duration: 5, attackType: 'wall', warningType: 'row', bulletSpeed: 130, spawnRate: 7, damage: 17, arenaEffect: 'none', patternTags: ['wall', 'combo'], execute: 'puppetDance' },
      { id: 'lu3', name: 'Moon Drop', description: 'Giant slow bullets fall.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 110, spawnRate: 2, damage: 17, arenaEffect: 'none', patternTags: ['rain', 'large'], execute: 'moonDrop' },
      { id: 'lu4', name: 'Blood Curtain', description: 'Fast sweeping red laser.', duration: 4, attackType: 'laser', warningType: 'row', bulletSpeed: 0, spawnRate: 2, damage: 17, arenaEffect: 'none', patternTags: ['laser', 'fast'], execute: 'bloodCurtain' },
      { id: 'lu5', name: 'Puppet Dance II', description: 'Tighter wall path.', duration: 5, attackType: 'wall', warningType: 'row', bulletSpeed: 135, spawnRate: 7, damage: 17, arenaEffect: 'none', patternTags: ['wall'], execute: 'puppetDance' },
      { id: 'lu6', name: 'Moon Shatter', description: 'Ring contracts then shatters.', duration: 5, attackType: 'ring', warningType: 'ring', bulletSpeed: 160, spawnRate: 24, damage: 17, arenaEffect: 'none', patternTags: ['ring', 'burst'], execute: 'moonShatter' },
      { id: 'lu7', name: 'Puppet Dance III', description: 'Wall + rain combo.', duration: 5, attackType: 'wall', warningType: 'row', bulletSpeed: 140, spawnRate: 7, damage: 17, arenaEffect: 'none', patternTags: ['wall'], execute: 'puppetDance' },
      { id: 'lu8', name: 'Moon Drop II', description: 'More moon drops.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 112, spawnRate: 3, damage: 17, arenaEffect: 'none', patternTags: ['rain'], execute: 'moonDrop' },
      { id: 'lu9', name: 'String Pull II', description: 'Heavier diagonal pull.', duration: 5, attackType: 'pull', warningType: 'arrow', bulletSpeed: 165, spawnRate: 6, damage: 17, arenaEffect: 'pull', patternTags: ['pull'], execute: 'stringPull' },
      { id: 'lu10', name: 'Puppet Dance IV', description: 'Max wall pressure.', duration: 5, attackType: 'wall', warningType: 'row', bulletSpeed: 145, spawnRate: 7, damage: 17, arenaEffect: 'none', patternTags: ['wall'], execute: 'puppetDance' },
      { id: 'lu11', name: 'Moon Shatter II', description: 'Faster moon shatter.', duration: 5, attackType: 'ring', warningType: 'ring', bulletSpeed: 165, spawnRate: 24, damage: 17, arenaEffect: 'none', patternTags: ['ring'], execute: 'moonShatter' },
      { id: 'lu12', name: 'String Pull III', description: 'Cross-diagonal pull.', duration: 5, attackType: 'pull', warningType: 'arrow', bulletSpeed: 168, spawnRate: 6, damage: 17, arenaEffect: 'pull', patternTags: ['pull'], execute: 'stringPull' },
      { id: 'lu13', name: 'Blood Curtain II', description: 'Double curtain sweep.', duration: 4, attackType: 'laser', warningType: 'row', bulletSpeed: 0, spawnRate: 2, damage: 17, arenaEffect: 'none', patternTags: ['laser'], execute: 'bloodCurtain' },
      { id: 'lu14', name: 'Puppet Dance V', description: 'Final wall dance.', duration: 5, attackType: 'wall', warningType: 'row', bulletSpeed: 150, spawnRate: 7, damage: 17, arenaEffect: 'none', patternTags: ['wall'], execute: 'puppetDance' },
      { id: 'lu15', name: 'Moon Drop III', description: 'Max moon drops.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 115, spawnRate: 4, damage: 17, arenaEffect: 'none', patternTags: ['rain'], execute: 'moonDrop' },
      { id: 'lu16', name: 'Puppet Dance VI', description: 'Heavy puppet pressure.', duration: 5, attackType: 'wall', warningType: 'row', bulletSpeed: 152, spawnRate: 7, damage: 17, arenaEffect: 'none', patternTags: ['wall'], execute: 'puppetDance' },
      { id: 'lu17', name: 'Blood Curtain III', description: 'Triple sweep.', duration: 4, attackType: 'laser', warningType: 'row', bulletSpeed: 0, spawnRate: 2, damage: 17, arenaEffect: 'none', patternTags: ['laser'], execute: 'bloodCurtain' },
      { id: 'lu18', name: 'Puppet Dance VII', description: 'Max puppet combo.', duration: 5, attackType: 'wall', warningType: 'row', bulletSpeed: 155, spawnRate: 7, damage: 17, arenaEffect: 'none', patternTags: ['wall'], execute: 'puppetDance' },
      { id: 'lu19', name: 'Moon Drop IV', description: 'Dense moon drops.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 118, spawnRate: 4, damage: 17, arenaEffect: 'none', patternTags: ['rain'], execute: 'moonDrop' },
      { id: 'lu20', name: 'String Pull IV', description: 'Max diagonal pull.', duration: 5, attackType: 'pull', warningType: 'arrow', bulletSpeed: 172, spawnRate: 6, damage: 17, arenaEffect: 'pull', patternTags: ['pull'], execute: 'stringPull' },
      { id: 'lu21', name: 'Moon Shatter III', description: 'Final shatter burst.', duration: 5, attackType: 'ring', warningType: 'ring', bulletSpeed: 175, spawnRate: 24, damage: 17, arenaEffect: 'none', patternTags: ['ring'], execute: 'moonShatter' },
      { id: 'lu22', name: 'String Pull Final', description: 'Final string pull.', duration: 5, attackType: 'pull', warningType: 'arrow', bulletSpeed: 178, spawnRate: 6, damage: 17, arenaEffect: 'pull', patternTags: ['pull'], execute: 'stringPull' },
      { id: 'lu23', name: 'Curtain Call', description: 'Final blood curtain sweep.', duration: 4, attackType: 'laser', warningType: 'row', bulletSpeed: 0, spawnRate: 2, damage: 17, arenaEffect: 'none', patternTags: ['laser'], execute: 'bloodCurtain' },
    ],
  },
  {
    name: 'Soulvex',
