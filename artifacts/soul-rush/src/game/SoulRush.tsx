...
const BOSSES: BossConf[] = [
  ...
  },
  {
    ...
    waves: [
      ...
      { id: 'z4', name: 'Static Nest', description: 'Static erupts from all four corners in spreading bursts.', duration: 4, attackType: 'corner', warningType: 'corner', bulletSpeed: 162, spawnRate: 32, damage: 20, arenaEffect: 'static', patternTags: ['corner'], execute: 'staticNest' },
      ...
      { id: 'z12', name: 'Web Collapse', description: 'Web lines collapse inward from all sides in an accelerating ring.', duration: 4, attackType: 'corner', warningType: 'corner', bulletSpeed: 168, spawnRate: 32, damage: 20, arenaEffect: 'static', patternTags: ['corner'], execute: 'staticNest' },
      ...
      { id: 'z14', name: 'Static Mirror', description: 'A static clone appears in the corner and mirrors corner eruptions.', duration: 4, attackType: 'corner', warningType: 'corner', bulletSpeed: 172, spawnRate: 32, damage: 20, arenaEffect: 'static', patternTags: ['corner'], execute: 'staticNest' },
      ...
      { id: 'z18', name: 'Final Broadcast', description: 'Every static system activates at once in a final corrupted transmission.', duration: 4, attackType: 'corner', warningType: 'corner', bulletSpeed: 176, spawnRate: 32, damage: 20, arenaEffect: 'static', patternTags: ['corner'], execute: 'staticNest' },
  ...
  },
  {
    ...
    waves: [
      ...
      { id: 'at3', name: 'Crater Burst', description: 'Random craters explode in bursts from unmarked positions.', duration: 4, attackType: 'burst', warningType: 'area', bulletSpeed: 187, spawnRate: 25, damage: 19, arenaEffect: 'none', patternTags: ['burst', 'random'], execute: 'craterBurst' },
      ...
      { id: 'at6', name: 'Magma Steps', description: 'Magma pools appear in stepping-stone sequences forcing narrow paths.', duration: 4, attackType: 'burst', warningType: 'area', bulletSpeed: 191, spawnRate: 25, damage: 19, arenaEffect: 'none', patternTags: ['burst'], execute: 'craterBurst' },
      ...
      { id: 'at8', name: 'Titan Toss', description: 'Giant rocks are thrown as large burst explosions from random points.', duration: 4, attackType: 'burst', warningType: 'area', bulletSpeed: 193, spawnRate: 25, damage: 19, arenaEffect: 'none', patternTags: ['burst', 'large'], execute: 'craterBurst' },
      ...
      { id: 'at13', name: 'Cracked Horizon', description: 'The horizon line becomes a sweeping hazard that crosses the screen.', duration: 4, attackType: 'burst', warningType: 'area', bulletSpeed: 195, spawnRate: 25, damage: 19, arenaEffect: 'none', patternTags: ['burst'], execute: 'craterBurst' },
      ...
      { id: 'at15', name: 'Moon Bounce', description: 'Moon bullets bounce off the arena walls before homing in.', duration: 4, attackType: 'burst', warningType: 'area', bulletSpeed: 198, spawnRate: 25, damage: 19, arenaEffect: 'none', patternTags: ['burst'], execute: 'craterBurst' },
      ...
      { id: 'at17', name: 'Core Break', description: 'Magma erupts from the center in a radial crater explosion.', duration: 4, attackType: 'burst', warningType: 'area', bulletSpeed: 202, spawnRate: 25, damage: 19, arenaEffect: 'none', patternTags: ['burst'], execute: 'craterBurst' },
  ...
  },
  {
    ...
    waves: [
      ...
      { id: 'm10', name: 'Memory Flood', description: 'The crystal rain overwrites itself mid-pattern with a denser repeat.', duration: 6, attackType: 'rain', warningType: 'top', bulletSpeed: 201, spawnRate: 10, damage: 18, arenaEffect: 'none', patternTags: ['rain'], execute: 'crystalRepeat' },
      ...
      { id: 'm14', name: 'Shattered Memory', description: 'The crystal rain pattern shatters into sub-bullets mid-fall.', duration: 6, attackType: 'rain', warningType: 'top', bulletSpeed: 206, spawnRate: 10, damage: 18, arenaEffect: 'none', patternTags: ['rain'], execute: 'crystalRepeat' },
      ...
      { id: 'm18', name: 'Crystal Cascade', description: 'Crystal rain cascades in three sequential waves with no pause between.', duration: 6, attackType: 'rain', warningType: 'top', bulletSpeed: 209, spawnRate: 10, damage: 18, arenaEffect: 'none', patternTags: ['rain'], execute: 'crystalRepeat' },
      ...
      { id: 'm22', name: 'Record Break', description: 'The archive fires its final crystal pattern — heavier than anything before.', duration: 6, attackType: 'rain', warningType: 'top', bulletSpeed: 216, spawnRate: 10, damage: 18, arenaEffect: 'none', patternTags: ['rain'], execute: 'crystalRepeat' },
    ],
  },
  {
    name: 'Lunara',
  ...
  },
  {
    ...
    waves: [
      ...
      { id: 's3', name: 'Broken Controls', description: 'Your movement controls invert — left is right, up is down. Bullets rain in.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 202, spawnRate: 10, damage: 15, arenaEffect: 'flip', patternTags: ['rain', 'flip'], execute: 'brokenControls' },
      ...
      { id: 's8', name: 'Static Mind', description: 'Controls shift randomly mid-wave — you can\'t tell which direction does what.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 206, spawnRate: 10, damage: 15, arenaEffect: 'flip', patternTags: ['rain', 'flip'], execute: 'brokenControls' },
      ...
      { id: 's10', name: 'Error Loop', description: 'Your controls loop — each button press delays by half a second.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 208, spawnRate: 10, damage: 15, arenaEffect: 'flip', patternTags: ['rain', 'flip'], execute: 'brokenControls' },
      ...
      { id: 's16', name: 'Lost Input', description: 'Controls barely respond — a 1-second delay on every movement input.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 211, spawnRate: 10, damage: 15, arenaEffect: 'flip', patternTags: ['rain', 'flip'], execute: 'brokenControls' },
      ...
      { id: 's21', name: 'System Break', description: 'Every control input breaks — movement is now random for the duration.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 216, spawnRate: 10, damage: 15, arenaEffect: 'flip', patternTags: ['rain', 'flip'], execute: 'brokenControls' },
      ...
      { id: 's24', name: 'The First Mistake', description: 'Maximum chaos erupts — rings, lasers, and bullets fill every corner at once.', duration: 6, attackType: 'chaos', warningType: 'all', bulletSpeed: 202, spawnRate: 20, damage: 15, arenaEffect: 'all', patternTags: ['chaos', 'finale'], execute: 'firstMistake' },
      { id: 's25', name: 'The Last Attempt', description: 'The original sin fires one final time — everything, everywhere, all at once.', duration: 6, attackType: 'chaos', warningType: 'all', bulletSpeed: 212, spawnRate: 20, damage: 15, arenaEffect: 'all', patternTags: ['chaos', 'finale'], execute: 'firstMistake' },
    ],
  },
];
