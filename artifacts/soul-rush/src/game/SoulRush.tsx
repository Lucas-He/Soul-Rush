...
const BOSSES: BossConf[] = [
  ...
  // ── Bosses 11–20 ─────────────────────────────────────────────
  {
    ...
    waves: [
      { id: 'v1', name: 'Spore Bloom', description: 'Radial spore burst from center.', duration: 5, attackType: 'radial', warningType: 'ring', bulletSpeed: 100, spawnRate: 8, damage: 17, arenaEffect: 'none', patternTags: ['radial', 'slow'], execute: 'sporeBloom' },
      { id: 'v2', name: 'Plague Garden', description: 'Danger zones bloom across arena.', duration: 6, attackType: 'zone', warningType: 'area', bulletSpeed: 0, spawnRate: 2, damage: 17, arenaEffect: 'plague', patternTags: ['zone', 'spread'], execute: 'plagueGarden' },
      { id: 'v3', name: 'Velvet Swarm', description: 'Homing spore bullets rain down.', duration: 5, attackType: 'homing', warningType: 'top', bulletSpeed: 120, spawnRate: 8, damage: 17, arenaEffect: 'none', patternTags: ['homing', 'rain'], execute: 'velvetSwarm' },
      { id: 'v4', name: 'Fever Rings', description: 'Three expanding concentric rings.', duration: 4, attackType: 'ring', warningType: 'ring', bulletSpeed: 95, spawnRate: 3, damage: 17, arenaEffect: 'none', patternTags: ['ring', 'multi'], execute: 'feverRings' },
      { id: 'v5', name: 'Moth Eclipse', description: 'Full-arena ring contracts with small gap.', duration: 4, attackType: 'ring', warningType: 'ring', bulletSpeed: 80, spawnRate: 1, damage: 17, arenaEffect: 'eclipse', patternTags: ['ring', 'gap'], execute: 'mothEclipse' },
      { id: 'v6', name: 'Garden Surge', description: 'Denser plague zones.', duration: 6, attackType: 'zone', warningType: 'area', bulletSpeed: 0, spawnRate: 2, damage: 17, arenaEffect: 'plague', patternTags: ['zone'], execute: 'plagueGarden' },
      { id: 'v7', name: 'Velvet Veil', description: 'Heavy spore swarm.', duration: 5, attackType: 'homing', warningType: 'top', bulletSpeed: 130, spawnRate: 8, damage: 17, arenaEffect: 'none', patternTags: ['homing'], execute: 'velvetSwarm' },
      { id: 'v8', name: 'Spore Spiral', description: 'Dense spiral bloom.', duration: 5, attackType: 'radial', warningType: 'ring', bulletSpeed: 100, spawnRate: 8, damage: 17, arenaEffect: 'none', patternTags: ['radial'], execute: 'sporeBloom' },
      { id: 'v9', name: 'Fever Rings II', description: 'Faster concentric rings.', duration: 4, attackType: 'ring', warningType: 'ring', bulletSpeed: 105, spawnRate: 3, damage: 17, arenaEffect: 'none', patternTags: ['ring', 'multi'], execute: 'feverRings' },
      { id: 'v10', name: 'Plague Crown', description: 'Corner eruption burst.', duration: 4, attackType: 'corner', warningType: 'corner', bulletSpeed: 150, spawnRate: 24, damage: 17, arenaEffect: 'none', patternTags: ['corner', 'burst'], execute: 'plagueCrown' },
      { id: 'v11', name: 'Spore Bloom II', description: 'Heavier radial burst.', duration: 5, attackType: 'radial', warningType: 'ring', bulletSpeed: 105, spawnRate: 9, damage: 17, arenaEffect: 'none', patternTags: ['radial'], execute: 'sporeBloom' },
      { id: 'v12', name: 'Velvet Storm', description: 'Max spore homing.', duration: 5, attackType: 'homing', warningType: 'top', bulletSpeed: 135, spawnRate: 8, damage: 17, arenaEffect: 'none', patternTags: ['homing'], execute: 'velvetSwarm' },
      { id: 'v13', name: 'Moth Eclipse II', description: 'Closing moth ring, faster.', duration: 4, attackType: 'ring', warningType: 'ring', bulletSpeed: 85, spawnRate: 1, damage: 17, arenaEffect: 'eclipse', patternTags: ['ring', 'gap'], execute: 'mothEclipse' },
      { id: 'v14', name: 'Crown Burst', description: 'Heavy corner eruption.', duration: 4, attackType: 'corner', warningType: 'corner', bulletSpeed: 160, spawnRate: 24, damage: 17, arenaEffect: 'none', patternTags: ['corner', 'burst'], execute: 'plagueCrown' },
      { id: 'v15', name: 'Final Bloom', description: 'Maximum spore finale.', duration: 5, attackType: 'radial', warningType: 'ring', bulletSpeed: 110, spawnRate: 10, damage: 17, arenaEffect: 'none', patternTags: ['radial'], execute: 'sporeBloom' },
    ],
  },
  {
    name: 'Echora',
    ...
    waves: [
      { id: 'e1', name: 'Sound Bars', description: 'Piano-key laser bars sweep inward.', duration: 5, attackType: 'laser', warningType: 'column', bulletSpeed: 0, spawnRate: 4, damage: 17, arenaEffect: 'none', patternTags: ['laser', 'sweep'], execute: 'soundBars' },
      { id: 'e2', name: 'Choir Split', description: 'Diagonal quad burst.', duration: 4, attackType: 'quad', warningType: 'center', bulletSpeed: 160, spawnRate: 20, damage: 17, arenaEffect: 'none', patternTags: ['quad', 'burst'], execute: 'choirSplit' },
      { id: 'e3', name: 'Crescendo Crush', description: 'Accelerating laser sweep.', duration: 5, attackType: 'laser', warningType: 'row', bulletSpeed: 0, spawnRate: 1, damage: 17, arenaEffect: 'none', patternTags: ['laser', 'accel'], execute: 'crescendoCrush' },
      { id: 'e4', name: 'Silent Beat', description: 'Long silence then massive burst.', duration: 5, attackType: 'radial', warningType: 'pulse', bulletSpeed: 200, spawnRate: 48, damage: 17, arenaEffect: 'none', patternTags: ['radial', 'burst'], execute: 'silentBeat' },
      { id: 'e5', name: 'Sound Bars II', description: 'Faster piano-key bars.', duration: 5, attackType: 'laser', warningType: 'column', bulletSpeed: 0, spawnRate: 5, damage: 17, arenaEffect: 'none', patternTags: ['laser'], execute: 'soundBars' },
      { id: 'e6', name: 'Choir Split II', description: 'Denser diagonal burst.', duration: 4, attackType: 'quad', warningType: 'center', bulletSpeed: 165, spawnRate: 22, damage: 17, arenaEffect: 'none', patternTags: ['quad'], execute: 'choirSplit' },
      { id: 'e7', name: 'Silent Beat II', description: 'Heavier silent burst.', duration: 5, attackType: 'radial', warningType: 'pulse', bulletSpeed: 200, spawnRate: 48, damage: 17, arenaEffect: 'none', patternTags: ['radial'], execute: 'silentBeat' },
      { id: 'e8', name: 'Double Tempo', description: 'Two sweeping lasers back to back.', duration: 6, attackType: 'laser', warningType: 'multi', bulletSpeed: 0, spawnRate: 2, damage: 17, arenaEffect: 'none', patternTags: ['laser', 'multi'], execute: 'doubleTempo' },
      { id: 'e9', name: 'Choir Split III', description: 'Max choir burst.', duration: 4, attackType: 'quad', warningType: 'center', bulletSpeed: 170, spawnRate: 24, damage: 17, arenaEffect: 'none', patternTags: ['quad'], execute: 'choirSplit' },
      { id: 'e10', name: 'Crescendo Crush II', description: 'Fast crescendo sweep.', duration: 5, attackType: 'laser', warningType: 'row', bulletSpeed: 0, spawnRate: 2, damage: 17, arenaEffect: 'none', patternTags: ['laser'], execute: 'crescendoCrush' },
      { id: 'e11', name: 'Silent Beat III', description: 'Dense silent volley.', duration: 5, attackType: 'radial', warningType: 'pulse', bulletSpeed: 200, spawnRate: 48, damage: 17, arenaEffect: 'none', patternTags: ['radial'], execute: 'silentBeat' },
      { id: 'e12', name: 'Sound Bars III', description: 'Dense piano bars.', duration: 5, attackType: 'laser', warningType: 'column', bulletSpeed: 0, spawnRate: 6, damage: 17, arenaEffect: 'none', patternTags: ['laser'], execute: 'soundBars' },
      { id: 'e13', name: 'Silent Beat IV', description: 'Heaviest silent beat.', duration: 5, attackType: 'radial', warningType: 'pulse', bulletSpeed: 200, spawnRate: 48, damage: 17, arenaEffect: 'none', patternTags: ['radial'], execute: 'silentBeat' },
      { id: 'e14', name: 'Double Tempo II', description: 'Max tempo double sweep.', duration: 6, attackType: 'laser', warningType: 'multi', bulletSpeed: 0, spawnRate: 2, damage: 17, arenaEffect: 'none', patternTags: ['laser', 'multi'], execute: 'doubleTempo' },
      { id: 'e15', name: 'Final Choir', description: 'Last quad burst.', duration: 4, attackType: 'quad', warningType: 'center', bulletSpeed: 175, spawnRate: 26, damage: 17, arenaEffect: 'none', patternTags: ['quad'], execute: 'choirSplit' },
      { id: 'e16', name: 'Sound Bars Final', description: 'Closing piano bars.', duration: 5, attackType: 'laser', warningType: 'column', bulletSpeed: 0, spawnRate: 7, damage: 17, arenaEffect: 'none', patternTags: ['laser'], execute: 'soundBars' },
    ],
  },
  {
    name: 'Vantus',
    ...
    waves: [
      { id: 'va1', name: 'Gravity Pull', description: 'Bullets arc toward center.', duration: 5, attackType: 'gravity', warningType: 'ring', bulletSpeed: 80, spawnRate: 7, damage: 17, arenaEffect: 'gravity', patternTags: ['gravity', 'arc'], execute: 'gravityPull' },
      { id: 'va2', name: 'Orbit Break', description: 'Ring holds then explodes.', duration: 5, attackType: 'ring', warningType: 'ring', bulletSpeed: 200, spawnRate: 16, damage: 17, arenaEffect: 'none', patternTags: ['ring', 'burst'], execute: 'orbitBreak' },
      { id: 'va3', name: 'Collapse Ring', description: 'Ring shrinks from edge inward.', duration: 4, attackType: 'ring', warningType: 'ring', bulletSpeed: 75, spawnRate: 1, damage: 17, arenaEffect: 'none', patternTags: ['ring', 'gap'], execute: 'collapseRing' },
      { id: 'va4', name: 'Center Crush', description: 'All 4 pistons close to center.', duration: 5, attackType: 'piston', warningType: 'all', bulletSpeed: 0, spawnRate: 4, damage: 17, arenaEffect: 'none', patternTags: ['piston', 'multi'], execute: 'centerCrush' },
      { id: 'va5', name: 'Gravity Pull II', description: 'Heavy gravity arc.', duration: 5, attackType: 'gravity', warningType: 'ring', bulletSpeed: 85, spawnRate: 7, damage: 17, arenaEffect: 'gravity', patternTags: ['gravity'], execute: 'gravityPull' },
      { id: 'va6', name: 'Orbit Break II', description: 'Ring holds longer then bursts.', duration: 5, attackType: 'ring', warningType: 'ring', bulletSpeed: 205, spawnRate: 16, damage: 17, arenaEffect: 'none', patternTags: ['ring'], execute: 'orbitBreak' },
      { id: 'va7', name: 'Collapse Ring II', description: 'Faster ring contraction.', duration: 4, attackType: 'ring', warningType: 'ring', bulletSpeed: 80, spawnRate: 1, damage: 17, arenaEffect: 'none', patternTags: ['ring'], execute: 'collapseRing' },
      { id: 'va8', name: 'Gravity Spiral', description: 'Dense gravity arc barrage.', duration: 5, attackType: 'gravity', warningType: 'ring', bulletSpeed: 88, spawnRate: 8, damage: 17, arenaEffect: 'gravity', patternTags: ['gravity'], execute: 'gravityPull' },
      { id: 'va9', name: 'Center Crush II', description: 'Tighter center crush.', duration: 5, attackType: 'piston', warningType: 'all', bulletSpeed: 0, spawnRate: 4, damage: 17, arenaEffect: 'none', patternTags: ['piston'], execute: 'centerCrush' },
      { id: 'va10', name: 'Ring Collapse', description: 'Max ring collapse.', duration: 4, attackType: 'ring', warningType: 'ring', bulletSpeed: 85, spawnRate: 1, damage: 17, arenaEffect: 'none', patternTags: ['ring'], execute: 'collapseRing' },
      { id: 'va11', name: 'Orbit Break III', description: 'Largest orbit burst.', duration: 5, attackType: 'ring', warningType: 'ring', bulletSpeed: 210, spawnRate: 16, damage: 17, arenaEffect: 'none', patternTags: ['ring'], execute: 'orbitBreak' },
      { id: 'va12', name: 'Gravity Storm', description: 'Final gravity spiral.', duration: 5, attackType: 'gravity', warningType: 'ring', bulletSpeed: 90, spawnRate: 7, damage: 17, arenaEffect: 'gravity', patternTags: ['gravity'], execute: 'gravityPull' },
      { id: 'va13', name: 'Center Crush III', description: 'Triple center crush.', duration: 5, attackType: 'piston', warningType: 'all', bulletSpeed: 0, spawnRate: 4, damage: 17, arenaEffect: 'none', patternTags: ['piston'], execute: 'centerCrush' },
      { id: 'va14', name: 'Orbit Break IV', description: 'Max orbit explosion.', duration: 5, attackType: 'ring', warningType: 'ring', bulletSpeed: 210, spawnRate: 16, damage: 17, arenaEffect: 'none', patternTags: ['ring'], execute: 'orbitBreak' },
      { id: 'va15', name: 'Gravity Finale', description: 'Final gravity arc.', duration: 5, attackType: 'gravity', warningType: 'ring', bulletSpeed: 90, spawnRate: 7, damage: 17, arenaEffect: 'gravity', patternTags: ['gravity'], execute: 'gravityPull' },
      { id: 'va16', name: 'Collapse Final', description: 'Maximum ring contraction.', duration: 4, attackType: 'ring', warningType: 'ring', bulletSpeed: 90, spawnRate: 1, damage: 17, arenaEffect: 'none', patternTags: ['ring'], execute: 'collapseRing' },
      { id: 'va17', name: 'Core Crush', description: 'Final 4-way crush.', duration: 5, attackType: 'piston', warningType: 'all', bulletSpeed: 0, spawnRate: 4, damage: 17, arenaEffect: 'none', patternTags: ['piston'], execute: 'centerCrush' },
    ],
  },
  {
    name: 'Caloric',
    ...
    rewardItemPool: ['wax_seal', 'candle_ash'],
    waves: [
      { id: 'c1', name: 'Wax Drip', description: 'Sinusoidal dripping bullets.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 160, spawnRate: 8, damage: 17, arenaEffect: 'wax', patternTags: ['rain', 'arc'], execute: 'waxDrip' },
      { id: 'c2', name: 'Funeral March', description: 'Slow dense rows of bullets.', duration: 5, attackType: 'wall', warningType: 'top', bulletSpeed: 80, spawnRate: 8, damage: 17, arenaEffect: 'none', patternTags: ['wall', 'dense'], execute: 'funeralMarch' },
      { id: 'c3', name: 'Last Ember', description: 'Long warning then total burst.', duration: 5, attackType: 'radial', warningType: 'pulse', bulletSpeed: 175, spawnRate: 40, damage: 17, arenaEffect: 'none', patternTags: ['radial', 'burst'], execute: 'lastEmber' },
      { id: 'c4', name: 'Wax Flood', description: 'Danger zones flood from top.', duration: 5, attackType: 'zone', warningType: 'area', bulletSpeed: 0, spawnRate: 3, damage: 17, arenaEffect: 'wax', patternTags: ['zone'], execute: 'waxFlood' },
      { id: 'c5', name: 'Candle Tears', description: 'Arcing streams from above.', duration: 5, attackType: 'arc', warningType: 'top', bulletSpeed: 140, spawnRate: 5, damage: 17, arenaEffect: 'none', patternTags: ['arc', 'spread'], execute: 'candleTears' },
      { id: 'c6', name: 'Wax Drip II', description: 'Heavier wax drip.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 162, spawnRate: 8, damage: 17, arenaEffect: 'wax', patternTags: ['rain'], execute: 'waxDrip' },
      { id: 'c7', name: 'Funeral March II', description: 'Faster dense rows.', duration: 5, attackType: 'wall', warningType: 'top', bulletSpeed: 85, spawnRate: 8, damage: 17, arenaEffect: 'none', patternTags: ['wall'], execute: 'funeralMarch' },
      { id: 'c8', name: 'Wax Flood II', description: 'Denser zone flood.', duration: 5, attackType: 'zone', warningType: 'area', bulletSpeed: 0, spawnRate: 3, damage: 17, arenaEffect: 'wax', patternTags: ['zone'], execute: 'waxFlood' },
      { id: 'c9', name: 'Candle Tears II', description: 'Heavier arc streams.', duration: 5, attackType: 'arc', warningType: 'top', bulletSpeed: 145, spawnRate: 5, damage: 17, arenaEffect: 'none', patternTags: ['arc'], execute: 'candleTears' },
      { id: 'c10', name: 'Last Ember II', description: 'Brighter ember burst.', duration: 5, attackType: 'radial', warningType: 'pulse', bulletSpeed: 178, spawnRate: 40, damage: 17, arenaEffect: 'none', patternTags: ['radial'], execute: 'lastEmber' },
      { id: 'c11', name: 'Wax Drip III', description: 'Dense wax drip.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 164, spawnRate: 9, damage: 17, arenaEffect: 'wax', patternTags: ['rain'], execute: 'waxDrip' },
      { id: 'c12', name: 'Wax Flood III', description: 'Max zone flood.', duration: 5, attackType: 'zone', warningType: 'area', bulletSpeed: 0, spawnRate: 4, damage: 17, arenaEffect: 'wax', patternTags: ['zone'], execute: 'waxFlood' },
      { id: 'c13', name: 'Candle Tears III', description: 'Widest arc spread.', duration: 5, attackType: 'arc', warningType: 'top', bulletSpeed: 148, spawnRate: 5, damage: 17, arenaEffect: 'none', patternTags: ['arc'], execute: 'candleTears' },
      { id: 'c14', name: 'Wax Flood IV', description: 'Final zone flood.', duration: 5, attackType: 'zone', warningType: 'area', bulletSpeed: 0, spawnRate: 4, damage: 17, arenaEffect: 'wax', patternTags: ['zone'], execute: 'waxFlood' },
      { id: 'c15', name: 'Last Ember III', description: 'Maximum ember burst.', duration: 5, attackType: 'radial', warningType: 'pulse', bulletSpeed: 180, spawnRate: 44, damage: 17, arenaEffect: 'none', patternTags: ['radial'], execute: 'lastEmber' },
      { id: 'c16', name: 'Wax Drip IV', description: 'Final wax drip wave.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 166, spawnRate: 9, damage: 17, arenaEffect: 'wax', patternTags: ['rain'], execute: 'waxDrip' },
      { id: 'c17', name: 'Funeral March III', description: 'Final dense procession.', duration: 5, attackType: 'wall', warningType: 'top', bulletSpeed: 88, spawnRate: 8, damage: 17, arenaEffect: 'none', patternTags: ['wall'], execute: 'funeralMarch' },
      { id: 'c18', name: 'Final Ember', description: 'The last ember — max burst.', duration: 5, attackType: 'radial', warningType: 'pulse', bulletSpeed: 182, spawnRate: 48, damage: 17, arenaEffect: 'none', patternTags: ['radial'], execute: 'lastEmber' },
    ],
  },
  {
    name: 'Zylvira',
    ...
    waves: [
      { id: 'z1', name: 'Web Grid', description: 'H+V laser grid fires simultaneously.', duration: 4, attackType: 'grid', warningType: 'grid', bulletSpeed: 0, spawnRate: 4, damage: 17, arenaEffect: 'web', patternTags: ['laser', 'grid'], execute: 'webGrid' },
      { id: 'z2', name: 'Signal Bite', description: 'Targeted shot volleys.', duration: 4, attackType: 'aimed', warningType: 'target', bulletSpeed: 150, spawnRate: 5, damage: 17, arenaEffect: 'none', patternTags: ['aimed'], execute: 'signalBite' },
      { id: 'z3', name: 'Screen Tear', description: 'Fast horizontal laser slice ×2.', duration: 3, attackType: 'laser', warningType: 'row', bulletSpeed: 0, spawnRate: 2, damage: 17, arenaEffect: 'none', patternTags: ['laser', 'fast'], execute: 'screenTear' },
      { id: 'z4', name: 'Static Nest', description: 'Corner eruption spread.', duration: 4, attackType: 'corner', warningType: 'corner', bulletSpeed: 160, spawnRate: 32, damage: 17, arenaEffect: 'static', patternTags: ['corner'], execute: 'staticNest' },
      { id: 'z5', name: 'Web Grid II', description: 'Denser laser grid.', duration: 4, attackType: 'grid', warningType: 'grid', bulletSpeed: 0, spawnRate: 6, damage: 17, arenaEffect: 'web', patternTags: ['laser'], execute: 'webGrid' },
      { id: 'z6', name: 'VHS Storm', description: 'Random scattershot from all edges.', duration: 4, attackType: 'random', warningType: 'edge', bulletSpeed: 160, spawnRate: 15, damage: 17, arenaEffect: 'static', patternTags: ['random'], execute: 'vhsStorm' },
      { id: 'z7', name: 'Signal Bite II', description: 'Faster signal tracking.', duration: 4, attackType: 'aimed', warningType: 'target', bulletSpeed: 155, spawnRate: 5, damage: 17, arenaEffect: 'none', patternTags: ['aimed'], execute: 'signalBite' },
      { id: 'z8', name: 'Web Grid III', description: 'Maximum grid density.', duration: 4, attackType: 'grid', warningType: 'grid', bulletSpeed: 0, spawnRate: 8, damage: 17, arenaEffect: 'web', patternTags: ['laser'], execute: 'webGrid' },
      { id: 'z9', name: 'Static Nest II', description: 'Heavy corner eruptions.', duration: 4, attackType: 'corner', warningType: 'corner', bulletSpeed: 165, spawnRate: 32, damage: 17, arenaEffect: 'static', patternTags: ['corner'], execute: 'staticNest' },
      { id: 'z10', name: 'Signal Bite III', description: 'Max tracking volleys.', duration: 4, attackType: 'aimed', warningType: 'target', bulletSpeed: 160, spawnRate: 5, damage: 17, arenaEffect: 'none', patternTags: ['aimed'], execute: 'signalBite' },
      { id: 'z11', name: 'VHS Storm II', description: 'Denser VHS scatter.', duration: 4, attackType: 'random', warningType: 'edge', bulletSpeed: 165, spawnRate: 15, damage: 17, arenaEffect: 'static', patternTags: ['random'], execute: 'vhsStorm' },
      { id: 'z12', name: 'Web Grid IV', description: 'Final grid formation.', duration: 4, attackType: 'grid', warningType: 'grid', bulletSpeed: 0, spawnRate: 8, damage: 17, arenaEffect: 'web', patternTags: ['laser'], execute: 'webGrid' },
      { id: 'z13', name: 'Screen Tear II', description: 'Two screen tears rapid.', duration: 3, attackType: 'laser', warningType: 'row', bulletSpeed: 0, spawnRate: 2, damage: 17, arenaEffect: 'none', patternTags: ['laser'], execute: 'screenTear' },
      { id: 'z14', name: 'Static Nest III', description: 'Max corner eruption.', duration: 4, attackType: 'corner', warningType: 'corner', bulletSpeed: 170, spawnRate: 32, damage: 17, arenaEffect: 'static', patternTags: ['corner'], execute: 'staticNest' },
      { id: 'z15', name: 'Screen Tear III', description: 'Triple fast tears.', duration: 3, attackType: 'laser', warningType: 'row', bulletSpeed: 0, spawnRate: 3, damage: 17, arenaEffect: 'none', patternTags: ['laser'], execute: 'screenTear' },
      { id: 'z16', name: 'Signal Bite IV', description: 'Final targeting burst.', duration: 4, attackType: 'aimed', warningType: 'target', bulletSpeed: 170, spawnRate: 5, damage: 17, arenaEffect: 'none', patternTags: ['aimed'], execute: 'signalBite' },
      { id: 'z17', name: 'VHS Storm III', description: 'Max VHS scatter.', duration: 4, attackType: 'random', warningType: 'edge', bulletSpeed: 170, spawnRate: 15, damage: 17, arenaEffect: 'static', patternTags: ['random'], execute: 'vhsStorm' },
      { id: 'z18', name: 'Static Nest IV', description: 'Final corner eruption.', duration: 4, attackType: 'corner', warningType: 'corner', bulletSpeed: 175, spawnRate: 32, damage: 17, arenaEffect: 'static', patternTags: ['corner'], execute: 'staticNest' },
      { id: 'z19', name: 'Web Final', description: 'Final web grid assault.', duration: 4, attackType: 'grid', warningType: 'grid', bulletSpeed: 0, spawnRate: 8, damage: 17, arenaEffect: 'web', patternTags: ['laser'], execute: 'webGrid' },
    ],
  },
  {
    name: 'Atlas Minor',
    ...
    waves: [
      { id: 'at1', name: 'Meteor Lesson', description: 'Giant slow bullets rain down.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 160, spawnRate: 5, damage: 16, arenaEffect: 'quake', patternTags: ['rain', 'large'], execute: 'meteorLesson' },
      { id: 'at2', name: 'Planet Tilt', description: '6-arm rotating spiral.', duration: 5, attackType: 'spiral', warningType: 'center', bulletSpeed: 155, spawnRate: 6, damage: 16, arenaEffect: 'none', patternTags: ['spiral'], execute: 'planetTilt' },
      { id: 'at3', name: 'Crater Burst', description: 'Random-center explosion.', duration: 4, attackType: 'burst', warningType: 'area', bulletSpeed: 185, spawnRate: 25, damage: 16, arenaEffect: 'none', patternTags: ['burst', 'random'], execute: 'craterBurst' },
      { id: 'at4', name: 'Tiny Apocalypse', description: 'Rings + bullets simultaneously.', duration: 4, attackType: 'combo', warningType: 'ring', bulletSpeed: 130, spawnRate: 8, damage: 16, arenaEffect: 'none', patternTags: ['combo', 'ring'], execute: 'tinyApocalypse' },
      { id: 'at5', name: 'Meteor Lesson II', description: 'Heavier meteor fall.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 163, spawnRate: 5, damage: 16, arenaEffect: 'quake', patternTags: ['rain'], execute: 'meteorLesson' },
      { id: 'at6', name: 'Planet Tilt II', description: 'Faster rotating arms.', duration: 5, attackType: 'spiral', warningType: 'center', bulletSpeed: 160, spawnRate: 6, damage: 16, arenaEffect: 'none', patternTags: ['spiral'], execute: 'planetTilt' },
      { id: 'at7', name: 'Crater Burst II', description: 'Multiple burst explosions.', duration: 4, attackType: 'burst', warningType: 'area', bulletSpeed: 190, spawnRate: 25, damage: 16, arenaEffect: 'none', patternTags: ['burst'], execute: 'craterBurst' },
      { id: 'at8', name: 'Meteor Lesson III', description: 'Dense meteor rain.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 165, spawnRate: 6, damage: 16, arenaEffect: 'quake', patternTags: ['rain'], execute: 'meteorLesson' },
      { id: 'at9', name: 'Tiny Apocalypse II', description: 'Bigger chaos combo.', duration: 4, attackType: 'combo', warningType: 'ring', bulletSpeed: 135, spawnRate: 8, damage: 16, arenaEffect: 'none', patternTags: ['combo'], execute: 'tinyApocalypse' },
      { id: 'at10', name: 'Crater Burst III', description: 'Max burst explosions.', duration: 4, attackType: 'burst', warningType: 'area', bulletSpeed: 193, spawnRate: 25, damage: 16, arenaEffect: 'none', patternTags: ['burst'], execute: 'craterBurst' },
      { id: 'at11', name: 'Planet Tilt III', description: 'Max rotating spiral.', duration: 5, attackType: 'spiral', warningType: 'center', bulletSpeed: 165, spawnRate: 6, damage: 16, arenaEffect: 'none', patternTags: ['spiral'], execute: 'planetTilt' },
      { id: 'at12', name: 'Tiny Apocalypse III', description: 'Dense chaos combo.', duration: 4, attackType: 'combo', warningType: 'ring', bulletSpeed: 140, spawnRate: 8, damage: 16, arenaEffect: 'none', patternTags: ['combo'], execute: 'tinyApocalypse' },
      { id: 'at13', name: 'Meteor Lesson IV', description: 'Dense giant meteor.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 168, spawnRate: 6, damage: 16, arenaEffect: 'quake', patternTags: ['rain'], execute: 'meteorLesson' },
      { id: 'at14', name: 'Crater Burst IV', description: 'Mega crater burst.', duration: 4, attackType: 'burst', warningType: 'area', bulletSpeed: 196, spawnRate: 25, damage: 16, arenaEffect: 'none', patternTags: ['burst'], execute: 'craterBurst' },
      { id: 'at15', name: 'Planet Tilt IV', description: 'Dense rotating arms.', duration: 5, attackType: 'spiral', warningType: 'center', bulletSpeed: 170, spawnRate: 6, damage: 16, arenaEffect: 'none', patternTags: ['spiral'], execute: 'planetTilt' },
      { id: 'at16', name: 'Tiny Apocalypse IV', description: 'Max chaos finale.', duration: 4, attackType: 'combo', warningType: 'ring', bulletSpeed: 145, spawnRate: 8, damage: 16, arenaEffect: 'none', patternTags: ['combo'], execute: 'tinyApocalypse' },
      { id: 'at17', name: 'Meteor Lesson V', description: 'Final meteor density.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 170, spawnRate: 7, damage: 16, arenaEffect: 'quake', patternTags: ['rain'], execute: 'meteorLesson' },
      { id: 'at18', name: 'Crater Burst V', description: 'Final crater explosion.', duration: 4, attackType: 'burst', warningType: 'area', bulletSpeed: 200, spawnRate: 25, damage: 16, arenaEffect: 'none', patternTags: ['burst'], execute: 'craterBurst' },
      { id: 'at19', name: 'Planet Tilt V', description: 'Final spiral arms.', duration: 5, attackType: 'spiral', warningType: 'center', bulletSpeed: 173, spawnRate: 6, damage: 16, arenaEffect: 'none', patternTags: ['spiral'], execute: 'planetTilt' },
      { id: 'at20', name: 'Final Apocalypse', description: 'The last tiny apocalypse.', duration: 4, attackType: 'combo', warningType: 'ring', bulletSpeed: 150, spawnRate: 8, damage: 16, arenaEffect: 'none', patternTags: ['combo'], execute: 'tinyApocalypse' },
    ],
  },
  {
    name: 'Xiu',
    ...
    waves: [
      { id: 'x1', name: 'Paper Cuts', description: 'Diagonal laser volleys.', duration: 4, attackType: 'diag', warningType: 'line', bulletSpeed: 0, spawnRate: 3, damage: 16, arenaEffect: 'none', patternTags: ['diag', 'laser'], execute: 'paperCuts' },
      { id: 'x2', name: 'Folded Walls', description: 'V-walls closing inward.', duration: 5, attackType: 'laser', warningType: 'side', bulletSpeed: 0, spawnRate: 3, damage: 16, arenaEffect: 'none', patternTags: ['laser', 'wall'], execute: 'foldedWalls' },
      { id: 'x3', name: 'Ink Decree', description: 'Grid of danger zones.', duration: 5, attackType: 'zone', warningType: 'grid', bulletSpeed: 0, spawnRate: 2, damage: 16, arenaEffect: 'ink', patternTags: ['zone'], execute: 'inkDecree' },
      { id: 'x4', name: 'Royal Guillotine', description: 'Vertical slash + bullet spray.', duration: 4, attackType: 'slash', warningType: 'column', bulletSpeed: 170, spawnRate: 12, damage: 16, arenaEffect: 'none', patternTags: ['slash', 'burst'], execute: 'royalGuillotine' },
      { id: 'x5', name: 'Origami Spears', description: '8-directional laser spears.', duration: 3, attackType: 'diag', warningType: 'star', bulletSpeed: 0, spawnRate: 8, damage: 16, arenaEffect: 'none', patternTags: ['diag', 'laser'], execute: 'origamiSpears' },
      { id: 'x6', name: 'Folded Walls II', description: 'Denser closing walls.', duration: 5, attackType: 'laser', warningType: 'side', bulletSpeed: 0, spawnRate: 4, damage: 16, arenaEffect: 'none', patternTags: ['laser'], execute: 'foldedWalls' },
      { id: 'x7', name: 'Ink Decree II', description: 'Heavier grid zones.', duration: 5, attackType: 'zone', warningType: 'grid', bulletSpeed: 0, spawnRate: 2, damage: 16, arenaEffect: 'ink', patternTags: ['zone'], execute: 'inkDecree' },
      { id: 'x8', name: 'Royal Guillotine II', description: 'Double guillotine slash.', duration: 4, attackType: 'slash', warningType: 'column', bulletSpeed: 175, spawnRate: 12, damage: 16, arenaEffect: 'none', patternTags: ['slash'], execute: 'royalGuillotine' },
      { id: 'x9', name: 'Paper Cuts II', description: 'Angled diagonal lasers.', duration: 4, attackType: 'diag', warningType: 'line', bulletSpeed: 0, spawnRate: 3, damage: 16, arenaEffect: 'none', patternTags: ['diag'], execute: 'paperCuts' },
      { id: 'x10', name: 'Origami Spears II', description: 'Dense 8-way spears.', duration: 3, attackType: 'diag', warningType: 'star', bulletSpeed: 0, spawnRate: 8, damage: 16, arenaEffect: 'none', patternTags: ['diag'], execute: 'origamiSpears' },
      { id: 'x11', name: 'Ink Decree III', description: 'Full decree grid.', duration: 5, attackType: 'zone', warningType: 'grid', bulletSpeed: 0, spawnRate: 2, damage: 16, arenaEffect: 'ink', patternTags: ['zone'], execute: 'inkDecree' },
      { id: 'x12', name: 'Royal Guillotine III', description: 'Triple slash.', duration: 4, attackType: 'slash', warningType: 'column', bulletSpeed: 180, spawnRate: 12, damage: 16, arenaEffect: 'none', patternTags: ['slash'], execute: 'royalGuillotine' },
      { id: 'x13', name: 'Folded Walls III', description: 'Max closing walls.', duration: 5, attackType: 'laser', warningType: 'side', bulletSpeed: 0, spawnRate: 5, damage: 16, arenaEffect: 'none', patternTags: ['laser'], execute: 'foldedWalls' },
      { id: 'x14', name: 'Paper Cuts III', description: 'Dense diagonal cuts.', duration: 4, attackType: 'diag', warningType: 'line', bulletSpeed: 0, spawnRate: 3, damage: 16, arenaEffect: 'none', patternTags: ['diag'], execute: 'paperCuts' },
      { id: 'x15', name: 'Origami Spears III', description: 'Max spear volley.', duration: 3, attackType: 'diag', warningType: 'star', bulletSpeed: 0, spawnRate: 8, damage: 16, arenaEffect: 'none', patternTags: ['diag'], execute: 'origamiSpears' },
      { id: 'x16', name: 'Folded Walls IV', description: 'Final wall closure.', duration: 5, attackType: 'laser', warningType: 'side', bulletSpeed: 0, spawnRate: 5, damage: 16, arenaEffect: 'none', patternTags: ['laser'], execute: 'foldedWalls' },
      { id: 'x17', name: 'Royal Guillotine IV', description: 'Final slash execution.', duration: 4, attackType: 'slash', warningType: 'column', bulletSpeed: 183, spawnRate: 12, damage: 16, arenaEffect: 'none', patternTags: ['slash'], execute: 'royalGuillotine' },
      { id: 'x18', name: 'Ink Decree IV', description: 'Final ink grid.', duration: 5, attackType: 'zone', warningType: 'grid', bulletSpeed: 0, spawnRate: 2, damage: 16, arenaEffect: 'ink', patternTags: ['zone'], execute: 'inkDecree' },
      { id: 'x19', name: 'Paper Cuts IV', description: 'Final diagonal cuts.', duration: 4, attackType: 'diag', warningType: 'line', bulletSpeed: 0, spawnRate: 3, damage: 16, arenaEffect: 'none', patternTags: ['diag'], execute: 'paperCuts' },
      { id: 'x20', name: 'Origami Spears IV', description: 'Final spear burst.', duration: 3, attackType: 'diag', warningType: 'star', bulletSpeed: 0, spawnRate: 8, damage: 16, arenaEffect: 'none', patternTags: ['diag'], execute: 'origamiSpears' },
      { id: 'x21', name: 'Final Decree', description: 'Final royal slash.', duration: 4, attackType: 'slash', warningType: 'column', bulletSpeed: 185, spawnRate: 12, damage: 16, arenaEffect: 'none', patternTags: ['slash'], execute: 'royalGuillotine' },
    ],
  },
  {
    name: 'Mnemovex',
    ...
    waves: [
      { id: 'm1', name: 'Echo Trail', description: 'Bullets from past player positions.', duration: 5, attackType: 'echo', warningType: 'trail', bulletSpeed: 130, spawnRate: 5, damage: 16, arenaEffect: 'echo', patternTags: ['echo', 'memory'], execute: 'echoTrail' },
      { id: 'm2', name: 'Memory Replay', description: 'Replays a boss 1–5 attack.', duration: 5, attackType: 'replay', warningType: 'random', bulletSpeed: 0, spawnRate: 0, damage: 16, arenaEffect: 'none', patternTags: ['replay'], execute: 'memoryReplay' },
      { id: 'm3', name: 'Vault Lock', description: 'Grid laser with blinking pattern.', duration: 5, attackType: 'grid', warningType: 'grid', bulletSpeed: 0, spawnRate: 4, damage: 16, arenaEffect: 'none', patternTags: ['laser', 'grid'], execute: 'vaultLock' },
      { id: 'm4', name: 'Crystal Repeat', description: 'Rain pattern played twice.', duration: 6, attackType: 'rain', warningType: 'top', bulletSpeed: 190, spawnRate: 10, damage: 16, arenaEffect: 'none', patternTags: ['rain', 'repeat'], execute: 'crystalRepeat' },
      { id: 'm5', name: 'Echo Trail II', description: 'Heavier echo burst.', duration: 5, attackType: 'echo', warningType: 'trail', bulletSpeed: 135, spawnRate: 5, damage: 16, arenaEffect: 'echo', patternTags: ['echo'], execute: 'echoTrail' },
      { id: 'm6', name: 'Vault Lock II', description: 'Alternate lock pattern.', duration: 5, attackType: 'grid', warningType: 'grid', bulletSpeed: 0, spawnRate: 4, damage: 16, arenaEffect: 'none', patternTags: ['laser'], execute: 'vaultLock' },
      { id: 'm7', name: 'Crystal Repeat II', description: 'Offset repeat rain.', duration: 6, attackType: 'rain', warningType: 'top', bulletSpeed: 195, spawnRate: 10, damage: 16, arenaEffect: 'none', patternTags: ['rain'], execute: 'crystalRepeat' },
      { id: 'm8', name: 'Echo Trail III', description: 'Dense echo volleys.', duration: 5, attackType: 'echo', warningType: 'trail', bulletSpeed: 140, spawnRate: 5, damage: 16, arenaEffect: 'echo', patternTags: ['echo'], execute: 'echoTrail' },
      { id: 'm9', name: 'Vault Lock III', description: 'Double blink lock.', duration: 5, attackType: 'grid', warningType: 'grid', bulletSpeed: 0, spawnRate: 4, damage: 16, arenaEffect: 'none', patternTags: ['laser'], execute: 'vaultLock' },
      { id: 'm10', name: 'Crystal Repeat III', description: 'Max offset repeat.', duration: 6, attackType: 'rain', warningType: 'top', bulletSpeed: 200, spawnRate: 10, damage: 16, arenaEffect: 'none', patternTags: ['rain'], execute: 'crystalRepeat' },
      { id: 'm11', name: 'Echo Trail IV', description: 'Max trail burst.', duration: 5, attackType: 'echo', warningType: 'trail', bulletSpeed: 145, spawnRate: 5, damage: 16, arenaEffect: 'echo', patternTags: ['echo'], execute: 'echoTrail' },
      { id: 'm12', name: 'Memory Replay II', description: 'Different boss replay.', duration: 5, attackType: 'replay', warningType: 'random', bulletSpeed: 0, spawnRate: 0, damage: 16, arenaEffect: 'none', patternTags: ['replay'], execute: 'memoryReplay' },
      { id: 'm13', name: 'Vault Lock IV', description: 'Final dual lock.', duration: 5, attackType: 'grid', warningType: 'grid', bulletSpeed: 0, spawnRate: 4, damage: 16, arenaEffect: 'none', patternTags: ['laser'], execute: 'vaultLock' },
      { id: 'm14', name: 'Crystal Repeat IV', description: 'Max crystal repeat.', duration: 6, attackType: 'rain', warningType: 'top', bulletSpeed: 205, spawnRate: 10, damage: 16, arenaEffect: 'none', patternTags: ['rain'], execute: 'crystalRepeat' },
      { id: 'm15', name: 'Echo Trail V', description: 'Final echo trail.', duration: 5, attackType: 'echo', warningType: 'trail', bulletSpeed: 150, spawnRate: 5, damage: 16, arenaEffect: 'echo', patternTags: ['echo'], execute: 'echoTrail' },
      { id: 'm16', name: 'Memory Replay III', description: 'Third unique replay.', duration: 5, attackType: 'replay', warningType: 'random', bulletSpeed: 0, spawnRate: 0, damage: 16, arenaEffect: 'none', patternTags: ['replay'], execute: 'memoryReplay' },
      { id: 'm17', name: 'Vault Lock V', description: 'Max vault grid.', duration: 5, attackType: 'grid', warningType: 'grid', bulletSpeed: 0, spawnRate: 4, damage: 16, arenaEffect: 'none', patternTags: ['laser'], execute: 'vaultLock' },
      { id: 'm18', name: 'Crystal Repeat V', description: 'Dense repeated rain.', duration: 6, attackType: 'rain', warningType: 'top', bulletSpeed: 208, spawnRate: 10, damage: 16, arenaEffect: 'none', patternTags: ['rain'], execute: 'crystalRepeat' },
      { id: 'm19', name: 'Echo Trail VI', description: 'Heavy final echo.', duration: 5, attackType: 'echo', warningType: 'trail', bulletSpeed: 155, spawnRate: 5, damage: 16, arenaEffect: 'echo', patternTags: ['echo'], execute: 'echoTrail' },
      { id: 'm20', name: 'Vault Lock VI', description: 'Final lock pattern.', duration: 5, attackType: 'grid', warningType: 'grid', bulletSpeed: 0, spawnRate: 4, damage: 16, arenaEffect: 'none', patternTags: ['laser'], execute: 'vaultLock' },
      { id: 'm21', name: 'Echo Trail VII', description: 'Maximum echo volleys.', duration: 5, attackType: 'echo', warningType: 'trail', bulletSpeed: 160, spawnRate: 5, damage: 16, arenaEffect: 'echo', patternTags: ['echo'], execute: 'echoTrail' },
      { id: 'm22', name: 'Final Repeat', description: 'Final repeated crystal.', duration: 6, attackType: 'rain', warningType: 'top', bulletSpeed: 215, spawnRate: 10, damage: 16, arenaEffect: 'none', patternTags: ['rain'], execute: 'crystalRepeat' },
    ],
  },
  {
    name: 'Lunara',
    ...
    waves: [
      { id: 'lu1', name: 'String Pull', description: 'Diagonal forced movement + bullets.', duration: 5, attackType: 'pull', warningType: 'arrow', bulletSpeed: 160, spawnRate: 6, damage: 15, arenaEffect: 'pull', patternTags: ['pull', 'homing'], execute: 'stringPull' },
      { id: 'lu2', name: 'Puppet Dance', description: 'Laser walls with narrow safe path.', duration: 5, attackType: 'wall', warningType: 'row', bulletSpeed: 130, spawnRate: 7, damage: 15, arenaEffect: 'none', patternTags: ['wall', 'combo'], execute: 'puppetDance' },
      { id: 'lu3', name: 'Moon Drop', description: 'Giant slow bullets fall.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 110, spawnRate: 2, damage: 15, arenaEffect: 'none', patternTags: ['rain', 'large'], execute: 'moonDrop' },
      { id: 'lu4', name: 'Blood Curtain', description: 'Fast sweeping red laser.', duration: 4, attackType: 'laser', warningType: 'row', bulletSpeed: 0, spawnRate: 2, damage: 15, arenaEffect: 'none', patternTags: ['laser', 'fast'], execute: 'bloodCurtain' },
      { id: 'lu5', name: 'Puppet Dance II', description: 'Tighter wall path.', duration: 5, attackType: 'wall', warningType: 'row', bulletSpeed: 135, spawnRate: 7, damage: 15, arenaEffect: 'none', patternTags: ['wall'], execute: 'puppetDance' },
      { id: 'lu6', name: 'Moon Shatter', description: 'Ring contracts then shatters.', duration: 5, attackType: 'ring', warningType: 'ring', bulletSpeed: 160, spawnRate: 24, damage: 15, arenaEffect: 'none', patternTags: ['ring', 'burst'], execute: 'moonShatter' },
      { id: 'lu7', name: 'Puppet Dance III', description: 'Wall + rain combo.', duration: 5, attackType: 'wall', warningType: 'row', bulletSpeed: 140, spawnRate: 7, damage: 15, arenaEffect: 'none', patternTags: ['wall'], execute: 'puppetDance' },
      { id: 'lu8', name: 'Moon Drop II', description: 'More moon drops.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 112, spawnRate: 3, damage: 15, arenaEffect: 'none', patternTags: ['rain'], execute: 'moonDrop' },
      { id: 'lu9', name: 'String Pull II', description: 'Heavier diagonal pull.', duration: 5, attackType: 'pull', warningType: 'arrow', bulletSpeed: 165, spawnRate: 6, damage: 15, arenaEffect: 'pull', patternTags: ['pull'], execute: 'stringPull' },
      { id: 'lu10', name: 'Puppet Dance IV', description: 'Max wall pressure.', duration: 5, attackType: 'wall', warningType: 'row', bulletSpeed: 145, spawnRate: 7, damage: 15, arenaEffect: 'none', patternTags: ['wall'], execute: 'puppetDance' },
      { id: 'lu11', name: 'Moon Shatter II', description: 'Faster moon shatter.', duration: 5, attackType: 'ring', warningType: 'ring', bulletSpeed: 165, spawnRate: 24, damage: 15, arenaEffect: 'none', patternTags: ['ring'], execute: 'moonShatter' },
      { id: 'lu12', name: 'String Pull III', description: 'Cross-diagonal pull.', duration: 5, attackType: 'pull', warningType: 'arrow', bulletSpeed: 168, spawnRate: 6, damage: 15, arenaEffect: 'pull', patternTags: ['pull'], execute: 'stringPull' },
      { id: 'lu13', name: 'Blood Curtain II', description: 'Double curtain sweep.', duration: 4, attackType: 'laser', warningType: 'row', bulletSpeed: 0, spawnRate: 2, damage: 15, arenaEffect: 'none', patternTags: ['laser'], execute: 'bloodCurtain' },
      { id: 'lu14', name: 'Puppet Dance V', description: 'Final wall dance.', duration: 5, attackType: 'wall', warningType: 'row', bulletSpeed: 150, spawnRate: 7, damage: 15, arenaEffect: 'none', patternTags: ['wall'], execute: 'puppetDance' },
      { id: 'lu15', name: 'Moon Drop III', description: 'Max moon drops.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 115, spawnRate: 4, damage: 15, arenaEffect: 'none', patternTags: ['rain'], execute: 'moonDrop' },
      { id: 'lu16', name: 'Puppet Dance VI', description: 'Heavy puppet pressure.', duration: 5, attackType: 'wall', warningType: 'row', bulletSpeed: 152, spawnRate: 7, damage: 15, arenaEffect: 'none', patternTags: ['wall'], execute: 'puppetDance' },
      { id: 'lu17', name: 'Blood Curtain III', description: 'Triple sweep.', duration: 4, attackType: 'laser', warningType: 'row', bulletSpeed: 0, spawnRate: 2, damage: 15, arenaEffect: 'none', patternTags: ['laser'], execute: 'bloodCurtain' },
      { id: 'lu18', name: 'Puppet Dance VII', description: 'Max puppet combo.', duration: 5, attackType: 'wall', warningType: 'row', bulletSpeed: 155, spawnRate: 7, damage: 15, arenaEffect: 'none', patternTags: ['wall'], execute: 'puppetDance' },
      { id: 'lu19', name: 'Moon Drop IV', description: 'Dense moon drops.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 118, spawnRate: 4, damage: 15, arenaEffect: 'none', patternTags: ['rain'], execute: 'moonDrop' },
      { id: 'lu20', name: 'String Pull IV', description: 'Max diagonal pull.', duration: 5, attackType: 'pull', warningType: 'arrow', bulletSpeed: 172, spawnRate: 6, damage: 15, arenaEffect: 'pull', patternTags: ['pull'], execute: 'stringPull' },
      { id: 'lu21', name: 'Moon Shatter III', description: 'Final shatter burst.', duration: 5, attackType: 'ring', warningType: 'ring', bulletSpeed: 175, spawnRate: 24, damage: 15, arenaEffect: 'none', patternTags: ['ring'], execute: 'moonShatter' },
      { id: 'lu22', name: 'String Pull Final', description: 'Final string pull.', duration: 5, attackType: 'pull', warningType: 'arrow', bulletSpeed: 178, spawnRate: 6, damage: 15, arenaEffect: 'pull', patternTags: ['pull'], execute: 'stringPull' },
      { id: 'lu23', name: 'Curtain Call', description: 'Final blood curtain sweep.', duration: 4, attackType: 'laser', warningType: 'row', bulletSpeed: 0, spawnRate: 2, damage: 15, arenaEffect: 'none', patternTags: ['laser'], execute: 'bloodCurtain' },
    ],
  },
  {
    name: 'Soulvex',
    ...
    waves: [
      { id: 's1', name: 'Regret Spiral', description: 'Dense 8-arm bullet spiral.', duration: 5, attackType: 'spiral', warningType: 'ring', bulletSpeed: 170, spawnRate: 8, damage: 14, arenaEffect: 'none', patternTags: ['spiral', 'dense'], execute: 'regretSpiral' },
      { id: 's2', name: 'Boss Memory Chain', description: 'Cycles through all boss attacks rapidly.', duration: 25, attackType: 'chain', warningType: 'all', bulletSpeed: 0, spawnRate: 0, damage: 14, arenaEffect: 'memory', patternTags: ['chain', 'replay'], execute: 'bossMemoryChain' },
      { id: 's3', name: 'Broken Controls', description: 'Flipped controls + bullet rain.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 200, spawnRate: 10, damage: 14, arenaEffect: 'flip', patternTags: ['rain', 'flip'], execute: 'brokenControls' },
      { id: 's4', name: 'Soul Duel', description: 'Mirror soul fires at you.', duration: 6, attackType: 'mirror', warningType: 'mirror', bulletSpeed: 160, spawnRate: 5, damage: 14, arenaEffect: 'mirror', patternTags: ['mirror'], execute: 'soulDuel' },
      { id: 's5', name: 'Regret Spiral II', description: 'Denser regret spiral.', duration: 5, attackType: 'spiral', warningType: 'ring', bulletSpeed: 175, spawnRate: 8, damage: 14, arenaEffect: 'none', patternTags: ['spiral'], execute: 'regretSpiral' },
      { id: 's6', name: 'Final Rule', description: 'All boss replay sequence.', duration: 9, attackType: 'sequence', warningType: 'all', bulletSpeed: 0, spawnRate: 0, damage: 14, arenaEffect: 'all', patternTags: ['sequence', 'replay'], execute: 'finalRule' },
      { id: 's7', name: 'Regret Spiral III', description: 'Max density spiral.', duration: 5, attackType: 'spiral', warningType: 'ring', bulletSpeed: 178, spawnRate: 8, damage: 14, arenaEffect: 'none', patternTags: ['spiral'], execute: 'regretSpiral' },
      { id: 's8', name: 'Broken Controls II', description: 'Double-flip rain barrage.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 205, spawnRate: 10, damage: 14, arenaEffect: 'flip', patternTags: ['rain', 'flip'], execute: 'brokenControls' },
      { id: 's9', name: 'Boss Memory Chain II', description: 'Second boss memory cycle.', duration: 25, attackType: 'chain', warningType: 'all', bulletSpeed: 0, spawnRate: 0, damage: 14, arenaEffect: 'memory', patternTags: ['chain'], execute: 'bossMemoryChain' },
      { id: 's10', name: 'Final Rule II', description: 'Second replay sequence.', duration: 9, attackType: 'sequence', warningType: 'all', bulletSpeed: 0, spawnRate: 0, damage: 14, arenaEffect: 'all', patternTags: ['sequence'], execute: 'finalRule' },
      { id: 's11', name: 'Soul Duel II', description: 'Mirror soul fires harder.', duration: 6, attackType: 'mirror', warningType: 'mirror', bulletSpeed: 165, spawnRate: 5, damage: 14, arenaEffect: 'mirror', patternTags: ['mirror'], execute: 'soulDuel' },
      { id: 's12', name: 'Regret Spiral IV', description: 'Heavy regret barrage.', duration: 5, attackType: 'spiral', warningType: 'ring', bulletSpeed: 180, spawnRate: 8, damage: 14, arenaEffect: 'none', patternTags: ['spiral'], execute: 'regretSpiral' },
      { id: 's13', name: 'Boss Memory Chain III', description: 'Third boss memory cycle.', duration: 25, attackType: 'chain', warningType: 'all', bulletSpeed: 0, spawnRate: 0, damage: 14, arenaEffect: 'memory', patternTags: ['chain'], execute: 'bossMemoryChain' },
      { id: 's14', name: 'Final Rule III', description: 'Third replay.', duration: 9, attackType: 'sequence', warningType: 'all', bulletSpeed: 0, spawnRate: 0, damage: 14, arenaEffect: 'all', patternTags: ['sequence'], execute: 'finalRule' },
      { id: 's15', name: 'Regret Spiral V', description: 'Dense spiral volley.', duration: 5, attackType: 'spiral', warningType: 'ring', bulletSpeed: 183, spawnRate: 8, damage: 14, arenaEffect: 'none', patternTags: ['spiral'], execute: 'regretSpiral' },
      { id: 's16', name: 'Broken Controls III', description: 'Max flip rain.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 210, spawnRate: 10, damage: 14, arenaEffect: 'flip', patternTags: ['rain', 'flip'], execute: 'brokenControls' },
      { id: 's17', name: 'Soul Duel III', description: 'Double mirror soul.', duration: 6, attackType: 'mirror', warningType: 'mirror', bulletSpeed: 170, spawnRate: 5, damage: 14, arenaEffect: 'mirror', patternTags: ['mirror'], execute: 'soulDuel' },
      { id: 's18', name: 'Boss Memory Chain IV', description: 'Fourth boss memory cycle.', duration: 25, attackType: 'chain', warningType: 'all', bulletSpeed: 0, spawnRate: 0, damage: 14, arenaEffect: 'memory', patternTags: ['chain'], execute: 'bossMemoryChain' },
      { id: 's19', name: 'Final Rule IV', description: 'Fourth replay.', duration: 9, attackType: 'sequence', warningType: 'all', bulletSpeed: 0, spawnRate: 0, damage: 14, arenaEffect: 'all', patternTags: ['sequence'], execute: 'finalRule' },
      { id: 's20', name: 'Regret Spiral VI', description: 'Maximum spiral density.', duration: 5, attackType: 'spiral', warningType: 'ring', bulletSpeed: 186, spawnRate: 8, damage: 14, arenaEffect: 'none', patternTags: ['spiral'], execute: 'regretSpiral' },
      { id: 's21', name: 'Broken Controls IV', description: 'Final flip barrage.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 215, spawnRate: 10, damage: 14, arenaEffect: 'flip', patternTags: ['rain', 'flip'], execute: 'brokenControls' },
      { id: 's22', name: 'Soul Duel IV', description: 'Final mirror soul.', duration: 6, attackType: 'mirror', warningType: 'mirror', bulletSpeed: 175, spawnRate: 5, damage: 14, arenaEffect: 'mirror', patternTags: ['mirror'], execute: 'soulDuel' },
      { id: 's23', name: 'Boss Memory Chain V', description: 'Final boss memory cycle.', duration: 25, attackType: 'chain', warningType: 'all', bulletSpeed: 0, spawnRate: 0, damage: 14, arenaEffect: 'memory', patternTags: ['chain'], execute: 'bossMemoryChain' },
      { id: 's24', name: 'The First Mistake', description: 'Maximum chaos — rings, lasers, bullets simultaneously.', duration: 6, attackType: 'chaos', warningType: 'all', bulletSpeed: 200, spawnRate: 20, damage: 14, arenaEffect: 'all', patternTags: ['chaos', 'finale'], execute: 'firstMistake' },
      { id: 's25', name: 'Final Rule V', description: 'The absolute last rule — total chaos sequence.', duration: 9, attackType: 'sequence', warningType: 'all', bulletSpeed: 0, spawnRate: 0, damage: 14, arenaEffect: 'all', patternTags: ['sequence', 'finale'], execute: 'finalRule' },
    ],
  },
];
