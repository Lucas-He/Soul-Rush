...
const BOSSES: BossConf[] = [
  ...
  },
  {
    ...
    waves: [
      ...
      { id: 's6', name: 'Soul Duel II', description: 'Mirror soul fires precision aimed volleys.', duration: 6, attackType: 'mirror', warningType: 'mirror', bulletSpeed: 165, spawnRate: 5, damage: 15, arenaEffect: 'mirror', patternTags: ['mirror', 'aimed'], execute: 'soulDuel' },
      ...
      { id: 's10', name: 'Broken Controls III', description: 'Controls flip while bullet rain intensifies.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 207, spawnRate: 10, damage: 15, arenaEffect: 'flip', patternTags: ['rain', 'flip'], execute: 'brokenControls' },
      { id: 's11', name: 'Soul Duel III', description: 'Mirror soul fires harder.', duration: 6, attackType: 'mirror', warningType: 'mirror', bulletSpeed: 165, spawnRate: 5, damage: 15, arenaEffect: 'mirror', patternTags: ['mirror'], execute: 'soulDuel' },
      ...
      { id: 's14', name: 'Regret Spiral V', description: 'Spiraling regret at maximum arm count.', duration: 5, attackType: 'spiral', warningType: 'ring', bulletSpeed: 188, spawnRate: 8, damage: 15, arenaEffect: 'none', patternTags: ['spiral', 'dense'], execute: 'regretSpiral' },
      { id: 's15', name: 'Regret Spiral VI', description: 'Dense spiral volley.', duration: 5, attackType: 'spiral', warningType: 'ring', bulletSpeed: 183, spawnRate: 8, damage: 15, arenaEffect: 'none', patternTags: ['spiral'], execute: 'regretSpiral' },
      { id: 's16', name: 'Broken Controls IV', description: 'Max flip rain.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 210, spawnRate: 10, damage: 15, arenaEffect: 'flip', patternTags: ['rain', 'flip'], execute: 'brokenControls' },
      { id: 's17', name: 'Soul Duel IV', description: 'Double mirror soul.', duration: 6, attackType: 'mirror', warningType: 'mirror', bulletSpeed: 170, spawnRate: 5, damage: 15, arenaEffect: 'mirror', patternTags: ['mirror'], execute: 'soulDuel' },
      ...
      { id: 's19', name: 'Soul Duel V', description: 'The mirror soul reflects your every move.', duration: 6, attackType: 'mirror', warningType: 'mirror', bulletSpeed: 172, spawnRate: 5, damage: 15, arenaEffect: 'mirror', patternTags: ['mirror', 'aimed'], execute: 'soulDuel' },
      { id: 's20', name: 'Regret Spiral VII', description: 'Maximum spiral density.', duration: 5, attackType: 'spiral', warningType: 'ring', bulletSpeed: 186, spawnRate: 8, damage: 15, arenaEffect: 'none', patternTags: ['spiral'], execute: 'regretSpiral' },
      { id: 's21', name: 'Broken Controls V', description: 'Final flip barrage.', duration: 5, attackType: 'rain', warningType: 'top', bulletSpeed: 215, spawnRate: 10, damage: 15, arenaEffect: 'flip', patternTags: ['rain', 'flip'], execute: 'brokenControls' },
      { id: 's22', name: 'Soul Duel VI', description: 'Final mirror soul.', duration: 6, attackType: 'mirror', warningType: 'mirror', bulletSpeed: 175, spawnRate: 5, damage: 15, arenaEffect: 'mirror', patternTags: ['mirror'], execute: 'soulDuel' },
      ...
      { id: 's25', name: 'The First Mistake II', description: 'The original sin erupts — rings, lasers and bullets fill every corner.', duration: 6, attackType: 'chaos', warningType: 'all', bulletSpeed: 210, spawnRate: 20, damage: 15, arenaEffect: 'all', patternTags: ['chaos', 'finale'], execute: 'firstMistake' },
    ],
  },
];
